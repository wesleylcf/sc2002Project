...
/**
* Represents a Junior Suite inside a hotel 
...
public class JuniorSuiteRoom extends Room{
    ...
    /** 
	 * Creates a new Junior Suite with the given room number, wifi setting, smoking rule and room status
	 ...
	 */
    public JuniorSuiteRoom(String roomNumber,int wifiEnabled, int smoking, RoomStatus status){
