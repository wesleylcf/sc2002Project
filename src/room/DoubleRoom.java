...
public class DoubleRoom extends Room{
    ...
    /** 
	 * Creates a new Double Room with the given room number, wifi setting, smoking rule and room status
	 ...
	 */
    public DoubleRoom(String roomNumber, int wifiEnabled, int smoking, RoomStatus status){
