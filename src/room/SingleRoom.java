...
public class SingleRoom extends Room{
    ...
    /** 
	 * Creates a new Single Room with the given room number, wifi setting, smoking rule and room status
	 ...
	 */
    public SingleRoom(String roomNumber, int wifiEnabled, int smoking, RoomStatus status){
