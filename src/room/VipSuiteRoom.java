...
/**
* Represents a VIP Suite inside a hotel 
...
public class VipSuiteRoom extends Room{
    ...
    /** 
	 * Creates a new VIP Suite with the given room number, wifi setting, smoking rule and room status
	 ...
	 */
    public VipSuiteRoom(String roomNumber, int wifiEnabled, int smoking, RoomStatus status){
